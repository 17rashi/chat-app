...
firebase.initializeApp({
  apiKey: "AIzaSyC3DWtxkyvaZ1b5rebGqpA4eVdicSOAPsM",
  authDomain: "chat-app-e5208.firebaseapp.com",
  projectId: "chat-app-e5208",
  storageBucket: "chat-app-e5208.appspot.com",
  messagingSenderId: "649229897696",
  appId: "1:649229897696:web:31129665eb67daa5aa2585"
});
    ...
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="https://alterclass.io/courses/react">
          {/* <img alt="Explore Other features" width={150} /> */}
